# AralActivator
Script zum automatischen Aktivieren von gekauften Aral Karten ("Aral SuperCard") und großes FAQ zu diesen Karten.

## 19.11.2022: Die Scripte und Infos dazu wurden nach unten verschoben, da Aral Supercards mittlerweile meist voraktiviert versendet werden und das FAQ in diesem Projekt somit nützlicher ist als die Scripte.
...
## Aral FAQ
####  Weiter unten findest du noch ein Cashback FAQ

###Achtung: Seit Dezember 2020 werden die Karten idR. automatisch aktiviert. Dieses FAQ enthält trotzdem noch Fragen und Antworten rund um die Aktivierung, die jedoch meist irrelevant sind!

**Bei online Aktionen: Wie werden die SuperCards verschickt?**  
* Per Brief/Post - jede Bestellung in einem Brief also idR. 2 Karten pro Brief.
* Sie werden meist einige Tage nach der Lieferung aktiviert, sodass man genug Zeit hat, fehlende Karten zu melden bevor Dritte diese einlösen können.
* Es gibt auch eSupercards (digitale Karten), die per Mail verschickt werden, aber Stand Nov. 2022 gab es diese noch nie vergünstigt.

**Muss ich die Karten überhaupt aktivieren, wenn sie ankommen?**  
Das variiert von Aktion zu Aktion:
* Bei [dieser](https://www.mydealz.de/deals/aral-supercard-einkaufen-und-tanken-fur-30-kaufen-5-supercard-einkaufen-und-tanken-geschenkt-jeweils-36-monate-gultig-1477242) im November 2019 musste man sie aktivieren.
* Seit [Dezember 2020](https://www.mydealz.de/deals/42eur-aral-supercard-fur-40eur-einlosbar-ab-1801-groupon-1719400) werden die Karten automatisch an einem bestimmten Datum aktiviert.
...
2. 10x Rechnung
3. [Optional] 10x Aktivierungscodes  
--> Letztlich 10x Briefe mit den SuperCards (jeweils 1-2 Karten pro Brief)

**Wann kommen die Aktivierungscodes?**  
Falls überhaupt welche benötigt werden:   
...
1. Schnellste Möglichkeit: Über dieses Script (nach unten Scrollen, siehe Anleitung).
...
**Achtung: Aktivierte Karten sind nie sofort einsetzbar! Immer erst am nächsten Tag!**  

**Was Kann man mit den SuperCards kaufen?**
Kommt drauf an, welche art von Karte du hast:
* Supercard Tanken und Einkaufen: Alles (auch Tabakwaren) außer Gutscheine/Geschenkkarten/Prepaid Aufladekarten/Paysafecards
* Tanken und Autopflege: Selbsterklärend
...
Nein. Auf MyDealz finden sich Gerüchte bzlg. einer Grenze von 100€ aber dies bezieht sich auf den Maximalbetrag an Tankkarten, die ein Kunde (pro Tag?) erwerben darf.

**Wie kann ich herausfinden, wie viel Guthaben/Restguthaben auf meiner SuperCard ist?**  
...
Falls du deine SuperCards registriert hast, kannst du das Guthaben und das Gültigkeitsdatum jederzeit ohne die Eingabe der Sicherheitscodes unter folgendem Link einsehen:  
https://www.aral-supercard.de/services/kartenverwaltung/

**Was bringt mir die Registrierung von AralSupercards?**  
Du bekommst bei Verlust (einfacher) Ersatz und kannst das verbleibende Guthaben jederzeit einsehen, ohne die Kartendaten erneut eingeben zu müssen.
...
**Bei älteren Aktionen: Werden die 4/5/6€ gratis SuperCards irgendwo im Bestellverlauf oder Warenkorb angezeigt?**  
...
**Wie lange sind die SuperCards gültig? Tags: Haltbarkeit, Gültigkeit, Ablaufdatum, Einlösebedingungen**
* SuperCards sind ab Aktivierungsdatum 36 Monate lang gültig (Laut offiziellem Aral FAQ, unten verlinkt)
* Manche Karten werden erst zu einem bestimmten Datum automatisch von Aral aktiviert
* SuperCards sind idR. erst ab dem nächsten Tag nach Aktivierungsdatum gültig
* Man kann an der Tankstellen-Kasse beliebig viele Karten verwenden; es gab mal eine angebliche Maximalsumme von 100€, die aber nicht mehr zu existieren scheint siehe: https://www.mydealz.de/comments/permalink/24512889
* Offline gekaufte Supercards sind sofort gültig, da sofort aktiviert(?)
Beispiel: Aktivierung am: 18.11.2022  
...
Diese Information ist einfach verifizierbar, indem du das Kartenguthaben abfragst oder deine Karte registrierst, um das Ablaufdatum einzusehen.

**Wie lange habe ich Zeit, nicht aktivierte Karten zu aktivieren?**  
...
**Wie lautet die Support E-Mail Adresse vom Aral Support?**  
...
Generell gab es seit anfang 2020 nur noch sehr selten bzw. mit Glück Cashback auf Aral Deals.  
[Quelle1](https://www.aklamio.com/de/shops/groupon_de) | [Quelle2](https://www.mydealz.de/comments/permalink/24747098)  
Ich empfehle, den Kauf von Supercards mit einer Kreditkarte mit Cashback zu erledigen das funktioniert auf jeden Fall.
...
PayBack E-Mails, die man als Antwort auf eine Anfrage über's Kontaktformular bekommt kann man nicht einfach per E-Mail beantworten.  
Antworten geht nur, indem man das Kontaktformular mitsamt aller Informationen erneut ausfüllt!  
Payback bietet mittlerweile auch Support per WhatsApp, was manchmal schneller gehen kann als per Mail: **01771781749**
...
* Die "Gültigkeit", die Groupon angibt liegt oft 1-2 Monate in der Zukunft und kann ignoriert werden. Sie bezieht sich auf die digitalen dummy-Gutscheine, die nach dem Kauf von Aral Supercards im Groupon Account hinterlegt werden.
* Die Karten werden zum angegebenen Zeitpunkt automatisch aktiviert: z.B. "Gültigkeit 31.12.2022", Versand am 14.01.2022, **Aktivierung** am 17.01.2022 --> Echte Gültigkeit bis: 17.01.2025. Mehr Details zur Gültigkeit von Aral Supercards siehe Aral FAQ bzw. Volltextsuche hier nach "Gültigkeit".
...
Stand 19.11.2022 fehlen diese Informationen auf dem Kassenbon mangels Implementation seitens Aral.  
...
* Aral Karten kauft man idR.nur, wenn es Rabatte und/oder Cashback  
...
- Karten (optional) automatisch registrieren
